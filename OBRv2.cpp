...
fc_obs.insert_rule("LG","LG","LG","QP");
 ...
 // Testa os sensores de linha para as possíveis condições de curva
  if ((senLinha[0] == 0 && senLinha[1] == 0 && senLinha[2] == 0 && senLinha[3] == 0) || (senLinha[0] == 0 && senLinha[1] == 0 && senLinha[2] == 0 && senLinha[3] == 1) || (senLinha[0] == 1 && senLinha[1] == 0 && senLinha[2] == 0 && senLinha[3] == 0)){// --|--
  	TestGreen = 1;}
  else{
  TestGreen = 0;}
 ...
 //##################################################################################################
  ...
  if ((senGreenLeft == 1) && (senGreenRigth == 1) && (TestGreen == 1)){ 
    int x = 0;
 ...
 //##################################################################################################
  ...
  for (int i = 0; i <4; i++){
  	...
  	if ((senLinha[0] == 1 && senLinha[1] == 0 && senLinha[2] == 0 && senLinha[3] == 1) || (senGreenLeft == 1)){ // Se Erro = 0
  		x = 1;
  		TestGreen = 0;
  			}   	 
    	}
 ...
 //=================================== Virar 90 graus à esquerda ====================================
 //##################################################################################################
 
  if ((senGreenLeft == 1) && (senGreenRigth == 0) && (TestGreen == 1)){
    int x = 0;
  ...
  for (int i = 0; i <4; i++){
  	...
  	if ((senLinha[0] == 1 && senLinha[1] == 0 && senLinha[2] == 0 && senLinha[3] == 1) || (senGreenRigth == 1)){ // Se Erro = 0
  		x = 1;
  		TestGreen = 0;
  			}   	 
    	}
